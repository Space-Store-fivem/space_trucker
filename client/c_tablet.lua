-- NO ENCRYPT Thank Fraser Watt
-- Source https://gist.github.com/FrazzIe/756b644f3d7ab5bf3f8c917793f8ac71
local tablet = false
...
function ToggleTablet(toggle)
    if toggle and not tablet and not HasPlayerCarryItem() then
        tablet = true

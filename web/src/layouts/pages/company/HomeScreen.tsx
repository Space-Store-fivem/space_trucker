            ...
            <main className="flex-1 flex flex-col">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                        ...
                        {canAccess('canManageFleet') && <AppButton iconPath="M20 6H4v12h16V6zM8 18v-5a4 4 0 118 0v5M4 14h16" iconClassName="text-sky-400 w-9 h-9" label="Garagem de Trailers" onClick={() => onAppSelect('trailer_garage')} />}

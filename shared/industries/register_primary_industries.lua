    ...
    }, --Wanted Storage Location
    {
        ...
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['fuel'] = {
                ...
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.OILFIELD_MURRIETA, 'fuel').price, --random min max
...
Industries:AddIndustry(
    ...
    spaceconfig.Industry.Type.Primary.CHEMICAL,
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['gunpowder'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.CHEMICAL_FACTORY, 'gunpowder').price, --random min max
                production = math.random(5,15), -- crate
                storageSize = 100,  -- crate
                inStock = math.random(10,50), -- crate
            },
            ['dyes'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.CHEMICAL_FACTORY, 'dyes').price, --random min max
...
Industries:AddIndustry(
    ...
    spaceconfig.Industry.Status.OPEN,
    spaceconfig.Industry.Tier.PRIMARY,
    spaceconfig.Industry.Type.Primary.SCRAPYARD,
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['scrap_metal'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.ROGERS_SCRAPYARD, 'scrap_metal').price, --random min max
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['scrap_metal'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.THOMSON_SCRAPYARD, 'scrap_metal').price, --random min max
                production = math.random(25,45), -- tonnes per hours
...
Industries:AddIndustry(
    ...
    spaceconfig.Industry.Status.OPEN,
    spaceconfig.Industry.Tier.PRIMARY,
    spaceconfig.Industry.Type.Primary.FOREST,
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['wood_log'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.FOREST_CENTER, 'wood_log').price, --random min max
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['fruits'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.ZANCUDO_FARM, 'fruits').price, --random min max
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['cotton'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.PALETO_BAY_FARM, 'cotton').price, --random min max
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['cereal'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N10_FARM, 'cereal').price, --random min max
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['cereal'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N11_FARM, 'cereal').price, --random min max
                production = math.random(2,6), -- tonnes
                storageSize = 100,  -- tonnes
                inStock = math.random(10,50), -- tonnes
            },
            ['milk'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N11_FARM, 'milk').price, --random min max
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['milk'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N12_FARM, 'milk').price, --random min max
                production = math.random(2,5), -- m3
                storageSize = 200,  -- m3
                inStock = math.random(10,20), -- m3
            },
            ['eggs'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N12_FARM, 'eggs').price, --random min max
                production = math.random(5,15), -- crate
                storageSize = 500,  -- crate
                inStock = math.random(10,20), -- crate
            },
            ['cereal'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N12_FARM, 'cereal').price, --random min max
                production = math.random(3,6), -- tons
                storageSize = 200,  -- tons
                inStock = math.random(10,20), -- tons
            },
            ['cotton'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N12_FARM, 'cotton').price, --random min max
                production = math.random(5,15), -- tonnes
                storageSize = 200,  -- tonnes
                inStock = math.random(10,50), -- tonnes
            },
            ['meat'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N12_FARM, 'meat').price, --random min max
                production = math.random(5,15), -- crate
                storageSize = 200,  -- crate
                inStock = math.random(10,50), -- crate
            },
            ['fruits'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N12_FARM, 'fruits').price, --random min max
                production = math.random(5,15), -- crates
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['cereal'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N14_FARM, 'cereal').price, --random min max
                production = math.random(1,5), -- tons
                storageSize = 100,  -- tons
                inStock = math.random(10,20), -- tons
            },
            ['meat'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N14_FARM, 'meat').price, --random min max
                production = math.random(5,15), -- crate
                storageSize = 100,  -- crate
                inStock = math.random(10,50), -- crate
            },
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['cotton'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N15_FARM, 'cotton').price, --random min max
                production = math.random(5,15), -- tonnes
                storageSize = 200,  -- tonnes
                inStock = math.random(10,50), -- tonnes
            },
            ['fruits'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.N15_FARM, 'fruits').price, --random min max
                production = math.random(5,15), -- crates
...
Industries:AddIndustry(
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['milk'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.LA_FUENTE_FARM, 'milk').price, --random min max
                production = math.random(1,5), -- m3
                storageSize = 100,  -- m3
                inStock = math.random(10,20), -- m3
            },
            ['eggs'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.LA_FUENTE_FARM, 'eggs').price, --random min max
                production = math.random(5,15), -- crate
                storageSize = 100,  -- crate
                inStock = math.random(10,20), -- crate
            },
            ['meat'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.LA_FUENTE_FARM, 'meat').price, --random min max
                production = math.random(5,15), -- crate
                storageSize = 100,  -- crate
                inStock = math.random(10,50), -- crate
            },
...
-- Mineral
Industries:AddIndustry(
    spaceconfig.Industry.Name.DAVIS_MINERAL,
    Lang:t('industry_name_davis_mineral'),
    spaceconfig.Industry.Status.OPEN,
    spaceconfig.Industry.Tier.PRIMARY,
    spaceconfig.Industry.Type.Primary.MINERAL,
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['ore'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.DAVIS_MINERAL, 'ore').price, --random min max
                production = math.random(5,15), -- tons
                storageSize = 100,  -- tons
                inStock = math.random(10,20), -- tons
            },
            ['aggregate'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.DAVIS_MINERAL, 'aggregate').price, --random min max
                production = math.random(5,15), -- tons
                storageSize = 100,  -- tons
                inStock = math.random(10,20), -- tons
            },
...
-- Quarry
Industries:AddIndustry(
    spaceconfig.Industry.Name.DAVIS_QUARRY,
    Lang:t('industry_name_davis_quarry'),
    spaceconfig.Industry.Status.OPEN,
    spaceconfig.Industry.Tier.PRIMARY,
    spaceconfig.Industry.Type.Primary.QUARRY,
    ...
    {}, --Wanted Storage Location
    {
        [spaceconfig.Industry.TradeType.FORSALE] = {
            ['aggregate'] = {
                price = Industries:GetIndustryItemPriceData(spaceconfig.Industry.Name.DAVIS_QUARRY, 'aggregate').price, --random min max
                production = math.random(5,15), -- tons
                storageSize = 80,  -- tons
                inStock = math.random(10,20), -- tons
            }
